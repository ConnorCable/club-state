import { VoiceRecorder, GenericResponse, RecordingData } from "capacitor-voice-recorder";
...
function stereoToMono(base64StereoData: string) {
  ...
  const startRecording = async (setRecordingCaptured : any, setRecordingStatus: any) => {
...
const stopRecording = async (setRecordingStatus: any, setRecordedData: any, setRecordingCaptured: any) => {
    try {
...
const resumeRecording = async (setRecordingStatus: any, ) => {
    try {
...
const handleRecordingButton = (startRecording: any, recordingStatus: any, resumeRecording: any, stopRecording: any) => {
    console.log("HELLO");
