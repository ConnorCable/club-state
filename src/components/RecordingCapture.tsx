...
const RecordingCapture: React.FC = () => {
  ...
  return (
    <IonContent style={{ zIndex: 2 }}>
      ...
      <IonButton disabled={recordingCaptured} onClick={playAudio2}>
        Playback Capture
      </IonButton>
            ...
            <Swiper>
              <SwiperSlide>
                <IonCard className="surveyCard">
                  ...
                  <IonCardContent className="ion-align-items-center ion-align-text-center">
                    <IonGrid>
                      <IonRow>
                        <IonCol>
              ...
              <SwiperSlide>
                <IonCard className="surveyCard">
                  ...
                  <IonCardContent className="ion-align-items-center ion-justify-content-center">
                    <IonGrid>
                      <IonRow>
                        <IonCol>
                          <IonButton color="danger">Dicks</IonButton>
                        </IonCol>
                        <IonCol>
                          <IonButton>Decent</IonButton>
                        </IonCol>
